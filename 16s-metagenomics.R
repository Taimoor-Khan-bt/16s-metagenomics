...
metadata_file <- NULL    # Optional metadata (set NULL if not available)
...
seqtab.filt <- seqtab.nochim[, seq_lengths >= 350 & seq_lengths <= 450]
cat("Retained", ncol(seqtab.filt), "ASVs after chimera and length filtering.\n")
